...
#ifndef RENDERMODES_NETHER_H_
#define RENDERMODES_NETHER_H_
...
class NetherRenderMode : public BaseRenderMode {
public:
	NetherRenderMode(const std::vector<mc::BlockPos>& hidden_dirs);
	virtual ~NetherRenderMode();

...
NetherRenderMode::NetherRenderMode(const std::vector<mc::BlockPos>& hidden_dirs)
	: hidden_dirs(hidden_dirs) {
}

NetherRenderMode::~NetherRenderMode() {
}

bool NetherRenderMode::isHidden(const mc::BlockPos& pos, uint16_t id, uint16_t data) {
}

bool NetherRenderMode::isHidden(const mc::BlockPos& pos, const BlockImage& block_image) {
